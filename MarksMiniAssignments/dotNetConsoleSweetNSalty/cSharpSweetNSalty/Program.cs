...
namespace cSharpSweetNSalty
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //variables
            int range = b - a;//finding the range Alec and others helped with this
            IEnumerable<int> all = Enumerable.Range(a, range);//enumerable allows you to use a range method
